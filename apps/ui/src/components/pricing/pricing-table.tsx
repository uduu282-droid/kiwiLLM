...
const plans: PricingPlan[] = [
		...
		metrics: [
			{
				...
				subtitle: "Access to a smaller starter set of hosted models",
			},
			{
				icon: Gauge,
				title: "10 RPM Rate Limits",
				subtitle: "Fair-use throughput for testing and lightweight usage",
			},
			{
				icon: Shield,
				title: "200 RPD Request Limit",
				subtitle: "Daily request cap with automatic reset",
			},
			{
				icon: ImageIcon,
				title: "20 images per day",
				subtitle: "Basic image generation allowance for free users",
			},
		],
	...
	},
	{
		...
		metrics: [
			{
				icon: Layers3,
				title: "Access to 100+ Good Quality Models",
				subtitle: "A stronger hosted catalog for real project usage",
			},
			{
				icon: Gauge,
				title: "10 RPM Rate Limits",
				subtitle: "More breathing room for active apps and internal tools",
			},
			{
				icon: Shield,
				title: "1000 RPD",
				subtitle: "Bigger daily quota for teams moving past testing",
			},
			{
				icon: ImageIcon,
				title: "50 images per day",
				subtitle: "More image generations for product and creative workflows",
			},
		],
		includesLabel: "Starter includes:",
		includes: [
			"Access to 100+ good quality models",
			"10 RPM rate limits",
		...
		metrics: [
			{
				icon: Gauge,
				title: "20 RPM",
				subtitle: "Higher throughput for serious project usage",
			},
			{
				icon: Shield,
				title: "2000 RPD",
				subtitle: "A larger daily allowance for growing teams",
			},
			{
				icon: Star,
				title: "Better Uptime Guarantee",
				subtitle: "Improved reliability for more important workloads",
			},
			{
				icon: ImageIcon,
				title: "100 images per day",
				subtitle: "Higher image-generation capacity for heavier usage",
			},
		],
